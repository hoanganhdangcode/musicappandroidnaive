...
public class SongSearchAdapter extends RecyclerView.Adapter<SongSearchAdapter.SongViewHolder> {
    ...
    public SongViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // SỬA 1: Phải trỏ đến R.layout.song_Search_item (File XML giao diện)
...
//        holder.tvRank.setText(String.valueOf(position + 1));
        ...
        Glide.with(context)
                ...
                .error(R.drawable.ic_music)       // Ảnh lỗi
                .into(holder.imgSong);
    ...
    public class SongViewHolder extends RecyclerView.ViewHolder {
        ...
        // Khai báo đúng các view có trong song_Search_item.xml
        ImageView imgSong;
